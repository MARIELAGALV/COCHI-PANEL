const CACHE='cochi-shell-v1.1.6-banner-horizontal-2';
const SHELL=['/','/index.html','/styles.css?v=1.1.6-mobile-clients-1','/app.js?v=1.1.6-banner-horizontal-2','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
