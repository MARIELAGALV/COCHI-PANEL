const CACHE='cochi-shell-1.1.6-redirect-persist-3';
const SHELL=['/','/index.html','/styles.css?v=1.1.6-redirect-persist-3','/app.js?v=1.1.6-redirect-persist-3','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
