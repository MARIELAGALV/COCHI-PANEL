const CACHE='cochi-shell-v1.1.6';
const SHELL=['/','/index.html','/styles.css?v=1.1.6','/app.js?v=1.1.6','/app-core-v1.1.6.js?v=1.1.6','/cookie-tools.js?v=1.1.6-cookie1','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
