...
function editContentItem(groupIndex,itemIndex=null){
  ...
  let templateNameRedirect2=String(templatePick('nameRedirect2','name_redirect2','redirectName2','redirect_name2')||'').trim();
  ...
  const templatePrefill={isTemplate:templateIsTemplate,nameRedirect:templateNameRedirect,nameRedirect2:templateNameRedirect2,codeRedirect:templateCodeRedirect,template:templateValue};
