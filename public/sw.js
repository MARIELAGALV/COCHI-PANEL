const CACHE='cochi-shell-1.1.6-channel-update-1';
const SHELL=['/','/index.html','/styles.css?v=1.1.6-channel-update-1','/app.js?v=1.1.6-channel-update-1','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
