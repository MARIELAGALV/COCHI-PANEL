...
async function loadHomeBanner(){
  ...
  $('#homeBannerEnabled').checked=!!b.enabled;$('#homeBannerType').value=b.type||'image';$('#homeBannerMediaUrl').value=b.mediaUrl||'';$('#homeBannerFallback').value=b.fallbackImage||'';$('#homeBannerEyebrow').value=b.eyebrow||'DESTACADO';$('#homeBannerTitle').value=b.title||'';$('#homeBannerDescription').value=b.description||'';$('#homeBannerMeta').value=b.meta||'';$('#homeBannerButtonText').value=b.buttonText||'Ver ahora';$('#homeBannerTargetSource').value=b.targetSource||'';$('#homeBannerTargetId').value=b.targetId||'';msg($('#homeBannerMsg'),'');
}
$('#saveHomeBannerBtn')?.addEventListener('click',async()=>{
  const banner={enabled:$('#homeBannerEnabled').checked,type:$('#homeBannerType').value,mediaUrl:$('#homeBannerMediaUrl').value.trim(),fallbackImage:$('#homeBannerFallback').value.trim(),eyebrow:$('#homeBannerEyebrow').value.trim(),title:$('#homeBannerTitle').value.trim(),description:$('#homeBannerDescription').value.trim(),meta:$('#homeBannerMeta').value.trim(),buttonText:$('#homeBannerButtonText').value.trim(),targetSource:$('#homeBannerTargetSource').value,targetId:$('#homeBannerTargetId').value.trim()};
  try{await api('/api/admin/home-banner',{method:'PUT',body:{banner}});msg($('#homeBannerMsg'),'BANNER GUARDADO. La portada lo recibirá al actualizar o volver a abrir CO-CHI.',true);toast('Banner principal actualizado','ok');await loadHomeBanner()}catch(e){msg($('#homeBannerMsg'),e.message);toast(e.message,'bad')}
});
