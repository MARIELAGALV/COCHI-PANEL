const CACHE='cochi-shell-1.1.6-clearkey-order-2';
const SHELL=['/','/index.html','/styles.css?v=1.1.6-clearkey-order-2','/app.js?v=1.1.6-clearkey-order-2','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
