const CACHE='cochi-shell-1.1.6-clearkey-order-4';
const SHELL=['/','/index.html','/styles.css?v=1.1.6-clearkey-order-4','/app.js?v=1.1.6-clearkey-order-4','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
